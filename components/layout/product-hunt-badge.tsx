  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col leading-tight">
        <span
          className="tracking-[0.15em] text-white/50 uppercase"
        ...
        >
          <span className="text-[#FF6154]">#3</span> Product of the Day
        </span>
      </div>
      ...
      <div className="ml-2 flex flex-col items-center rounded-md border border-white/10 px-2 py-1 transition-colors duration-300 group-hover:border-[#FF6154]/30 group-hover:bg-[#FF6154]/10">
        ...
        <span className="text-white/70" style={{ ...pixel, fontSize: "11px" }}>
          412
        </span>
      </div>
    </a>
